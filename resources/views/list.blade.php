...
<nav id="header" class="fixed w-full z-10 top-0">
  ...
  <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url({{ asset('assets/img/card-left.jpg') }})" title="Woman holding a mug">
  </div>
  <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
    ...
    <div class="flex items-center">
      <img class="w-10 h-10 rounded-full mr-4" src="{{ asset('assets/img/avatar.png') }}" alt="Avatar of Jonathan Reinink">
      <div class="text-sm">
...
&lt;/header&gt;
		...
		<div class="flex w-full items-center font-sans px-4 py-12">
			<img class="w-10 h-10 rounded-full mr-4" src="{{ asset('assets/img/avatar.png') }}" alt="Avatar of Author">
