...
class PostPolicy
{
    ...
    {
        return $user->hasAccess(['view-post']) && $user->uid == $post->posted_by;
    }
    ...
    {
        return $user->hasAccess(['update-post']) && $user->uid == $post->posted_by;
    }
    ...
    {
        return $user->hasAccess(['delete-post']) && $user->uid == $post->posted_by;
    }
